...
public class TestXifratge {
    public static void main(String[] args) {
        AlgorismeFactory[] aFactory = { new AlgorismeAES(), (AlgorismeFactory) new AlgorismeMonoalfabetic(), (AlgorismeFactory) new AlgorismePolialfabetic(), (AlgorismeFactory) new AlgorismeRotX()};
